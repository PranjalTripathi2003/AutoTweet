...
driver = webdriver.Chrome(executable_path="/Users/pranjaltripathi/Downloads/chromedriver")
driver.get("https://twitter.com/login")
sleep(3)
driver.find_element_by_name('session[username_or_email]').send_keys("Pranjal77430207")
driver.find_element_by_name('session[password]').send_keys("Tr1711$a")
